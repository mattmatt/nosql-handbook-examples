(function() {
  ...
  Meta = (function() {
    ...
    Meta.prototype.encodeData = function() {
      if (this.data != null) return this.data = new Buffer(this.encode(this.data));
    };
    ...
    Meta.prototype.load = function(options, additionalProperties, additionalDefaults, coreDefaults) {
      var defaults, props;
      var _this = this;
      ...
      this.usermeta = (options != null ? options.usermeta : void 0) || {};
      this.usermeta = Utils.mixin(true, this.usermeta, defaults, this, options);
      delete this.usermeta.usermeta;
      props = Utils.uniq(Meta.riakProperties.concat(additionalProperties).concat(Object.keys(defaults)));
      return props.forEach(function(key) {
        var value, _ref;
        value = (_ref = _this.popKey(key)) != null ? _ref : Meta.defaults[key];
        if (value != null) {
    ...
    Meta.prototype.addLink = function(link) {
      ...
      if (link) {
        ...
        if (!dupe) return this.links.push(link);
      }
    };
  ...
  Meta.riakProperties = ['bucket', 'key', 'contentType', 'vclock', 'lastMod', 'lastModUsecs', 'charset', 'contentEncoding', 'r', 'w', 'dw', 'rw', 'links', 'etag', 'raw', 'clientId', 'returnbody', 'vtag', 'range', 'contentRange', 'acceptRanges', 'headers'];
